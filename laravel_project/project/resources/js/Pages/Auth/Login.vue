...
<template>
    ...
    <form class="form w-100 auth-form" @submit.prevent="submit">
        ...
        <div class="form-floating mb-4">
            <input type="text" v-model="form.email" id="email" class="form-control auth-input" :class="{ 'is-invalid': form.errors.email }" placeholder="E-posta adresi veya kullanıcı adı" autocomplete="off" data-testid="login-email">
        ...
        <div class="form-floating mb-4 position-relative" data-kt-password-meter="true">
            <input type="password" v-model="form.password" id="password" class="form-control auth-input pe-5" :class="{ 'is-invalid': form.errors.password }" placeholder="Şifre" autocomplete="off" data-testid="login-password">
